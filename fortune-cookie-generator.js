...
document.getElementById("fortune-cookie-text").innerHTML = fortunesList[Math.floor(Math.random() * fortunesList.length)];
  ...
  var newFortune = document.createElement('li');
        // 2. Set the `innerHTML` of that element equal to the `innerHTML` of
        //    the `#fortune-cookie-text` element.
  newFortune.innerHTML = document.getElementById('fortune-cookie-text').innerHTML;
  ...
  previousFortune.appendChild(newFortune);
